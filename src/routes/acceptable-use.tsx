  ...
  return (
    ...
    >
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-neutral-900">1. Overview</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-neutral-900">2. Prohibited Activities</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-neutral-900">3. System Limits & Resource Usage</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-neutral-900">4. Violations & Enforcement</h2>
        <p>
