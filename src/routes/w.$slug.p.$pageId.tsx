...
export const Route = createFileRoute('/w/$slug/p/$pageId')({
  component: WorkspaceSlugPageIdRoute,
});

const SWITCHING_WORKSPACE_WORDS = [
  'Resolving workspace URL...',
  'Verifying document permissions...',
  'Switching active workspace...',
  'Opening document...',
];

function WorkspaceSlugPageIdRoute() {
  ...
  useEffect(() => {
    async function resolveWorkspaceAndPage() {
      try {
    ...
    resolveWorkspaceAndPage();
  }, [slug, pageId, navigate, queryClient]);
