...
function TermsPage() {
  return (
    ...
    >
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-neutral-900">2. User Accounts</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-neutral-900">3. Content Rights & Licensing</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-neutral-900">4. Service Modifications</h2>
        <p>
