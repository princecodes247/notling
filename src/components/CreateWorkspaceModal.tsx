      ...
      footer={
        <div className="flex items-center justify-end gap-2.5 w-full">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2.5 rounded-lg border border-stone-200 text-xs text-stone-700 font-medium hover:bg-stone-100 transition-colors cursor-pointer"
          >
            Cancel
          </button>
          <button
            ...
            className="px-4 py-2.5 rounded-lg bg-black hover:bg-neutral-800 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-medium tracking-tight transition-all cursor-pointer flex items-center justify-center gap-2 shadow-2xs active:scale-98"
          >
            {isSubmitting ? (
        ...
        <div className="flex items-end gap-3">
          ...
          <div className="relative shrink-0 group">
            ...
            <button
              ...
              className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-white hover:bg-stone-100 border border-stone-300 text-stone-600 flex items-center justify-center shadow-2xs cursor-pointer transition-all active:scale-90"
