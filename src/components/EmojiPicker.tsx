...
import { Search, X, Sparkles, Folder, Lightbulb, Smile, Leaf, MapPin, Trash2 } from 'lucide-react';
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1 px-2 py-1 rounded-md text-[11px] font-medium transition-colors cursor-pointer shrink-0 ${
                  isActive
            ...
            <div className="grid grid-cols-7 gap-1">
              {filteredEmojis.map((item) => (
                <button
                  ...
                  title={item.name}
                  className={`text-xl p-1.5 rounded-lg flex items-center justify-center transition-all cursor-pointer hover:bg-stone-100 dark:hover:bg-zinc-800 hover:scale-110 active:scale-95 ${
