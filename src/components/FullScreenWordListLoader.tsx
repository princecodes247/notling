...
export const FullScreenWordListLoader: React.FC<FullScreenWordListLoaderProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#f3f2ee] dark:bg-[#121214] text-stone-900 dark:text-zinc-100 flex flex-col items-center justify-center p-6 select-none font-sans overflow-hidden transition-colors duration-200">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-sm w-full text-center">
        ...
        <div className="h-8 flex items-center justify-center my-1 relative w-full overflow-hidden">
          {title ? (
            <h2 className="text-base font-semibold text-neutral-950 dark:text-white tracking-tight mb-1">
              {title}
            </h2>
          ) : (
            <AnimatePresence initial={false} mode="wait">
              <motion.div
                ...
                className="text-base font-medium text-neutral-950 dark:text-white tracking-tight mb-1 flex items-center justify-center gap-2"
              >
        ...
        {subtitle && (
          <p className="text-xs text-neutral-400 dark:text-zinc-500 mb-6 font-normal">
            {subtitle}
          </p>
        )}
        ...
        {showProgress && (
          <div className="w-48 h-1 bg-neutral-200/80 dark:bg-zinc-800 rounded-full overflow-hidden mt-4">
            <motion.div
