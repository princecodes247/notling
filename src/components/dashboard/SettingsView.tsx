...
import { Users, Check, Building, AlertTriangle, Trash2, X, Loader2, User, Lock, Sun } from 'lucide-react';
    ...
    <div className="flex-1 w-full h-full bg-white dark:bg-[#18181b] text-neutral-900 dark:text-zinc-100 flex flex-col overflow-y-auto select-none font-sans p-4 sm:p-10 pb-6 sm:pb-10 pt-safe">
      <div className="max-w-4xl mx-auto w-full flex flex-col gap-8">
        ...
        <div className="pb-5 border-b border-neutral-100 dark:border-zinc-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-normal text-neutral-950 dark:text-white tracking-tight">Settings</h1>
        ...
        {/* Tab Navigation */}
        <div className="flex items-center gap-2 border-b border-neutral-200/80 dark:border-zinc-800/80 pb-px">
          <button
            type="button"
            onClick={() => setActiveTab('profile')}
            className={`flex items-center gap-2 px-4 py-2.5 text-xs font-medium border-b-2 transition-colors cursor-pointer ${activeTab === 'profile'
              ? 'border-neutral-900 dark:border-white text-neutral-950 dark:text-white font-semibold'
              : 'border-transparent text-neutral-500 dark:text-zinc-400 hover:text-neutral-800 dark:hover:text-zinc-200 hover:border-neutral-300 dark:hover:border-zinc-700'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 text-xs font-medium border-b-2 transition-colors cursor-pointer ${activeTab === 'workspace'
              ? 'border-neutral-900 dark:border-white text-neutral-950 dark:text-white font-semibold'
              : 'border-transparent text-neutral-500 dark:text-zinc-400 hover:text-neutral-800 dark:hover:text-zinc-200 hover:border-neutral-300 dark:hover:border-zinc-700'
              }`}
          >
            ...
            Workspace Settings
            {!isWorkspaceOwner && (
              <span className="ml-1 text-[10px] px-1.5 py-0.5 rounded bg-amber-50 dark:bg-amber-950/50 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800 font-medium flex items-center gap-1">
